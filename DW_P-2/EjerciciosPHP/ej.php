...
echo "Área del triángulo: $area<br><br>";
?>
...
echo "$dolares dólares son L. $lempiras lempiras<br><br>";
?>
...
echo "$millas millas son $km km o $metros metros<br><br>";
?>
...
echo "$horas horas son $minutos minutos o $segundos segundos<br><br>";
?>
